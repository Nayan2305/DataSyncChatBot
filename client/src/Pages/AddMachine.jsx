...
const AddMachine = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    let config = {
      ...
      url: "http://127.0.0.1:5000/create_collection/S_W_23",
      headers: {
            ...
            <div className="input-grid">
              ...
              <div className="input-row">
                <input
                  type="text"
                  className="input-field"
                  placeholder="Parameter 9"
                  value={param9}
                  onChange={(e) => setParam9(e.target.value)}
                />
                <input
                  type="text"
                  className="input-field"
                  placeholder="Parameter 10"
                  value={param10}
