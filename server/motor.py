...
api_url = "http://iotapiserver.ap-south-1.elasticbeanstalk.com/api/insert_motor_data/abcd1234"  # Replace with your API endpoint

# Read data from the CSV file (assuming the CSV file has headers)

csv_file_path = 'G:\SEM7\PROJECT\DataSyncChatBot\server\data.csv'  # Replace with the path to your CSV file
